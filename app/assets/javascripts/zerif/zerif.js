...
//   delay:7000,
//   backgrounds:[
//     { src:'/assets/zerif/backgrounds/bg1.jpg', fade:1000 },
//     { src:'/assets/zerif/backgrounds/bg2.jpg', fade:1000 },
//     { src:'/assets/zerif/backgrounds/bg3.jpg', fade:1000 }
//   ]
// });
...
$("#contact-form").submit(function (e) {
    ...
    // var dataString = 'name=' + name + '&email=' + email + '&subject=' + subject + '&message=' + message + '&authenticity_token=' + AUTH_TOKEN;
    var params = {inquiry: {name: name, email: email, phone: phone, message: message}, authenticity_token: AUTH_TOKEN};
